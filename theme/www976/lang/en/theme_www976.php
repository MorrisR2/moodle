...
/**
 * Strings for component 'theme_www976', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   moodlecore
...
<div class="clearfix">
	<div class="theme_screenshot">
		...
		<h2>www976</h2>
		<img src="www976/pix/screenshot.jpg" />
	...
	<div class="theme_description">
		...
		<h2>About</h2>
		<p>www976 is a two-column, fluid-width theme coded for Moodle 2.0. It makes use of custom menus that appear above the site title on every page. It also includes a basic settings page allowing you to change link color, add a tagline above the site name on the front page, and add text to the footer.</p>

		<h2>Parents</h2>
		<p>This theme is built upon Fusion, Base and Canvas. If you wish to modify aspects of this theme beyond the settings offered, we advise creating a new  theme using this theme, Base and Canvas all as parents so updates to any of those themes in the core will find their way into your new theme.</p>
...
$string['configtitle'] = 'www976 settings';
