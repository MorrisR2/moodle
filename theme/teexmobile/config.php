...
/**
 * Config file for teexmobile theme
 *
 * @package    theme
...
if ($thisdevice == "default" || $thisdevice == "tablet" || optional_param('teexmobile_blocks', false, PARAM_BOOL)) {
...
$THEME->csspostprocess = 'teexmobile_user_settings';
