...
/**
 * General layout for the teexmobile theme
 *
 * @package    theme
...
// get blocks?
$toblock = optional_param('teexmobile_blocks', false, PARAM_BOOL);
// get settings?
$toset = optional_param('teexmobile_settings', false, PARAM_BOOL);
...
$urlblocks = new moodle_url($PAGE->url, array('teexmobile_blocks' => 'true'));
$urlsettings = new moodle_url($PAGE->url, array('teexmobile_settings' => 'true'));
...
if ($gowide) {
    ...
    teexmobile_initialise_colpos($PAGE);
}
$usercol = (teexmobile_get_colpos() == 'on');

$renderer = $PAGE->get_renderer('theme_teexmobile');

echo $OUTPUT->doctype() ?>
<html id="teexmobile" <?php echo $OUTPUT->htmlattributes() ?>>
<head>
          ...
          <?php } ?>
            ...
            <div class="content-secondary">
                ...
                <div data-role="fieldcontain" id="sliderdiv">
                    <label for="slider"><?php p(get_string('mtoggle','theme_teexmobile')); ?>:</label>
