...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>TEEXMobile</h2><img src="teexmobile/pix/screenshot.png" /><h2>About</h2><p>TEEXMobile is a mobile theme for Moodle 2.x. More information on modifying themes can be found in the <a href="http://docs.moodle.org/en/Theme">MoodleDocs</a>.</p></div></div>';
