...
/**
 * Renderers for the teexmobile theme
 *
 * @package    theme
...
/**
 * A custom renderer for the teexmobile theme to produce snippets of content.
 *
 * @package    theme
 * @subpackage teexmobile
 * @copyright  John Stabinger
...
class theme_teexmobile_renderer extends plugin_renderer_base {
...
/**
 * Overridden core renderer for the teexmobile theme
 *
 * @package    theme
 * @subpackage teexmobile
 * @copyright  John Stabinger
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_teexmobile_core_renderer extends core_renderer {
    ...
    public function block(block_contents $bc, $region) {
        ...
        $bc = clone($bc);
        // The teexmobile theme does not support collapsible blocks.
    ...
    protected function init_block_hider_js(block_contents $bc) {
        // The teexmobile theme in no shape or form supports the hiding of blocks
        // this function has been defined and left empty intentionally so that
        // the block hider JS is not even included.
    }

    /**
     * Produces the navigation bar for the teexmobile theme
     *
     * @return string
     */
    ...
    protected function render_help_icon(help_icon $helpicon) {
        ...
        $url = new moodle_url('/help.php', array('component' => $helpicon->component, 'identifier' => $helpicon->identifier, 'lang'=>current_language(), 'theme'=>'teexmobile'));
...
/**
 * Overridden choie module renderer for the teexmobile theme
 *
 * @package    theme
 * @subpackage teexmobile
 * @copyright  John Stabinger
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_teexmobile_mod_choice_renderer extends mod_choice_renderer {
