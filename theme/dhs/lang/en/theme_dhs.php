...
/**
 * Strings for component 'theme_dhs', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   moodlecore
...
<div class="clearfix">
	<div class="theme_screenshot">
		...
		<h2>DHS</h2>
		<img src="dhs/pix/screenshot.jpg" />
	...
	<div class="theme_description">
		...
		<h2>About</h2>
		<p>DHS is a two-column, fluid-width theme coded for Moodle 2.0. It makes use of custom menus that appear above the site title on every page. It also includes a basic settings page allowing you to change link color, add a tagline above the site name on the front page, and add text to the footer.</p>
...
$string['configtitle'] = 'DHS settings';
