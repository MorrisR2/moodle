...
/**
 * @package    profilefield_expiredenrolments
 * @category   profilefield
 * @copyright  2012 Rajesh Taneja
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

class profile_field_expiredenrolments extends profile_field_base {

    /**
     * Constructor
     *
     * Pulls out the options for expiredenrolments from the database and sets the
     * the corresponding key for the data if it exists
     *
     * @param int $fieldid id of user profile field
     * @param int $userid id of user
     */
    function profile_field_expiredenrolments($fieldid=0, $userid=0) {
        global $DB;
     ...
     * @return array of errors, fieldname=>'problem'
     **/
