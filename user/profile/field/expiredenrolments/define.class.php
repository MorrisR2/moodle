...
class profile_define_expiredenrolments extends profile_define_base {
    ...
    function define_form_specific($form) {
        ...
        $form->addElement('radio', 'defaultdata', get_string('mystring', 'profilefield_expiredenrolments'));
