...
$string['page-report-completion-index'] = 'Course completion flex report';
$string['page-report-completion-user']  = 'User course completion report';
$string['pluginname']                   = 'Course completion flex report';
$string['onlyactive']                   = 'Display only currently active enrollments';
