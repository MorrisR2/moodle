...
$string['pluginname'] = 'Statistics - ESTI';
...
$string['statistics'] = 'ESTI Statistics';
$string['statisticsesti'] = 'ESTI Statistics';
$string['statisticsesti:componentname'] = 'ESTI Quiz statistics report';
$string['statisticsestireport'] = 'ESTI Statistics report';
$string['statisticsestireportgraph'] = 'Statistics for question positions';
$string['statisticsesti:view'] = 'View ESTI statistics report';
$string['statsfor'] = 'ESTI Quiz statistics (for {$a})';
$string['min'] = 'Lowest grade';
$string['max'] = 'Highest grade';
