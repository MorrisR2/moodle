 ...
 *
 * It takes one parameter, the quiz_statisticsesti.id. This is enough to identify the
 * quiz etc.
 *
...
$quizstatistics = $DB->get_record('quiz_statisticsesti', array('id' => $quizstatisticsid));
...
$questionstatistics = $DB->get_records_select('quiz_question_statisticsesti',
...
$graph->parameter['x_label'] = get_string('position', 'quiz_statisticsesti');
...
$fieldstoplot = array(
    ...
    'discriminativeefficiency' => get_string('discriminative_efficiency', 'quiz_statisticsesti')
);
