 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_statisticsesti_question_stats {
    public $questions;
     ...
     */
    public function load_step_data($quizid, $currentgroup, $groupstudents, $allattempts, $fromtime = 0, $totime = 0xFFFFFFFF) {
        global $DB;
        ...
        list($fromqa, $whereqa, $qaparams) = quiz_statisticsesti_attempts_sql(
                $quizid, $currentgroup, $groupstudents, $allattempts, false, $fromtime, $totime);
        ...
        foreach ($this->subquestions as $qid => $subquestion) {
            ...
            if ($subquestionstats[$qid]->differentweights) {
                ...
                echo $OUTPUT->notification(
                        ...
                        'quiz_statisticsesti', $this->subquestions[$qid]->name));
            }
