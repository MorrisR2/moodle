 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
require_once dirname(__FILE__) . '/../statistics/responseanalysis.php';
class quiz_statisticsesti_response_analyser extends quiz_statistics_response_analyser {
    ...
    public function __construct($questiondata) {
        ...
        // print "responseanalysis.php 77: " . print_r($this->responseclasses, true) . "\r\n";
    }
    ...
    public function analyse($qubaids) {
        // echo "responseanalysis.php 127: ". print_r($qubaids, true); exit;
        // Load data.
