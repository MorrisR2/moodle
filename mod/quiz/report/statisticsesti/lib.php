 ...
 */
function quiz_statisticsesti_questiontext_preview_pluginfile($context, $questionid, $args, $forcedownload, array $options=array()) {
    global $CFG;
    ...
    require_capability('quiz/statisticsesti:view', $context);
 ...
 */
function quiz_statisticsesti_cron() {
    global $DB;

    $expiretime = time() - 5*HOURSECS;
    $todelete = $DB->get_records_select_menu('quiz_statisticsesti',
