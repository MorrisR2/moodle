...
/**
 * Unit tests for (some of) mod/quiz/report/statisticsesti/qstats.php.
 *
...
/**
 * Test helper subclass of quiz_statisticsesti_question_stats
 *
 * @copyright 2010 The Open University
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class testable_quiz_statisticsesti_question_stats extends quiz_statisticsesti_question_stats {
...
/**
 * Unit tests for (some of) quiz_statisticsesti_question_stats.
 *
 * @copyright 2008 Jamie Pratt
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_statisticsesti_question_stats_testcase extends basic_testcase {
    ...
    public function test_qstats() {
        ...
        $this->qstats = new testable_quiz_statisticsesti_question_stats($questions, 22, 10045.45455);
