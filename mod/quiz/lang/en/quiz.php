...
$string['completionpass_help'] = 'If enabled, this activity is considered complete when the student receives a passing grade, with the pass grade set in the gradebook. Optionally, also consider complete when the student exhausts all available attempts.';
