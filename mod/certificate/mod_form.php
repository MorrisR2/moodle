...
class mod_certificate_mod_form extends moodleform_mod {
    ...
    function definition() {
        ...
        $templateoptions = array('teex'=>'TEEX', 'dhs' => 'DHS', 'fsa' => 'FSA', 'itsi'=>'ITSI', 'psb'=>'PSB', 'tcfp'=>'TCFP');
		$mform->addElement('select', 'template', get_string('template', 'certificate'), $templateoptions);
        ...
        $mform->disabledIf('orientation', 'certificatetype', 'eq', 'smsweb');
        $mform->disabledIf('borderstyle', 'certificatetype', 'eq', 'smsweb');
        $mform->disabledIf('bordercolor', 'certificatetype', 'eq', 'smsweb');
        $mform->disabledIf('printwmark', 'certificatetype', 'eq', 'smsweb');
        $mform->disabledIf('printsignature', 'certificatetype', 'eq', 'smsweb');
        $mform->disabledIf('printseal', 'certificatetype', 'eq', 'smsweb');
