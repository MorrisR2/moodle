...
class question_bank_view {
    ...
    protected function init_search_conditions() {
        foreach (get_plugin_list_with_class('local', 'question_bank_search_condition_array', 'lib.php') as $searchplugin) {
            foreach ($searchplugin::get_conditions() as $searchclass) {
    ...
    public function display($tabname, $page, $perpage, $cat,
        ...
        $this->display_options($showquestiontext);
     ...
     * @deprecated Replaced by class question_bank_search_condition_category
     */
    ...
    protected function display_options($showquestiontext) {
        global $PAGE;
        ...
        $this->display_showtext_chk($showquestiontext);
        $this->display_advanced_search_form();
        $options = array('showmore'=>get_string('showmore', 'form'), 'showless'=>get_string('showless', 'form'), 'showadv'=>$showadv);
    ...
    protected function display_showtext_chk($showquestiontext) {
        echo '<div>';
     ...
     * @deprecated Instead use html_writer::checkbox and separate Javascript from HTML.
     */
...
abstract class question_bank_search_condition {
 ...
 /**
  * Subclassed by components to add search conditions / filters to the question bank display,
  * represented as question_bank_search_condition classes.
  * Currently consists of the method question_bank_search_condition_array, which returns an array 
  * of question_bank_search_condition class names (or subclasses thereof)
  */
