...
$string['configplugin'] = 'Setup repository within teex/repository';
$string['donotusesysdir'] = 'Don\'t use system directory as repository, including';
$string['teex:view'] = 'View TEEX repository';
...
$string['pluginname_help'] = 'Create repository from local teex/repository/ directory';
$string['pluginname'] = 'TEEX';
