...
function local_questionbankmodified_question_bank_column_types($question_bank_view) {
    return array('lastmodified' => new local_questionbankmodified_question_bank_column($question_bank_view));
}


class local_questionbankmodified_question_bank_column extends question_bank_column_base {
    public function get_name() {
        return 'local_questionbankmodified|lastmodified';
    }
    ...
    */
    ...
    public function is_sortable() {
        ...
        // return 'local_questionbankmodified';
    }
}
