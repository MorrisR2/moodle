...
$plugin->version   = 2014011408;      // The current plugin version (Date: YYYYMMDDXX)
$plugin->requires  = 2010031900;      // Requires this Moodle version
$plugin->cron      = 0;               // Period for cron to check this plugin (secs)
$plugin->component = 'local_completionnotify'; // To check on upgrade, that plugin sits in correct place
