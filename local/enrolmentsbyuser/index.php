...
require_capability('local/enrolmentsbyuser:viewenrolements', $context);

$PAGE->set_context($context);
$PAGE->set_url('/local/enrolmentsbyuser/index.php', array());
...
if (! empty($_REQUEST['choosecourse']) ) {
    ...
    $currentuserselector = new local_enrolmentsbyuser_existing_student('removeselect', $options);
}
